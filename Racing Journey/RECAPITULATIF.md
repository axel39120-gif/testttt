...
Version **BUILD v134**. Ce document résume ce qui a été fait, ce qui reste
...
L'épreuve se suit désormais à la **barre de progression** : circuit, tour en
cours, et messages d'ambiance qui ne révèlent rien du classement. Les
événements s'affichent par-dessus, chacun avec ses trois taux — réussite,
échec, échec critique. **Le classement complet apparaît au drapeau**, d'un
seul coup.

Les positions continuent d'être calculées à chaque tour, les événements en
dépendent ; elles ne sont simplement plus montrées avant l'arrivée. C'est ce
qui a permis de retirer tout l'appareillage d'affichage en direct, source de
la plupart des défauts rencontrés.
