...
(function() {
  ...
  (function _rjWrapPushHomeToast() {
    ...
    /* Retrait des émojis dans les notifications : c'est un filtre, pas un
       affichage. Inscription au registre des filtres (module 88). */
    if (!Array.isArray(window.RJ_TOAST_FILTERS)) window.RJ_TOAST_FILTERS = [];
    if (!window.RJ_TOAST_FILTERS.some(function (f) { return f && f.id === "07-user-fixes"; })) {
      window.RJ_TOAST_FILTERS.push({
        id: "07-user-fixes",
        filtre: function (label, text, color) {
          try {
...
(function _rjFixNetworkScreen() {
  ...
  (function _rjWrapRefreshForNetwork() {
    ...
    if (!window.RJ_SCREEN_HOOKS.some(function (h) { return h && h.id === "07-user-fixes"; })) {
      window.RJ_SCREEN_HOOKS.push({
        id: "07-user-fixes",
        ecran: "S-contact-thread",
...
(function _rjFixSocialFeed() {
  ...
  (function _rjWrapRefreshForSocial() {
    function doWrap() {
      ...
      var orig = window.refreshScreen;
      /* Réaction à l'écran médias : inscription au registre (module 88). */
      if (!Array.isArray(window.RJ_SCREEN_HOOKS)) window.RJ_SCREEN_HOOKS = [];
      if (!window.RJ_SCREEN_HOOKS.some(function (h) { return h && h.id === "07-user-fixes-media"; })) {
        window.RJ_SCREEN_HOOKS.push({
          id: "07-user-fixes-media",
          ecran: "S-media",
          apres: function (screenId) {
