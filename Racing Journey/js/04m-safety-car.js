...
(function rjSafetyCarSystem() {
  ...
  function _rjInstallUpdateLivePositionsWrapper() {
    /* Cette enveloppe préservait l'ordre du peloton pendant une
       neutralisation. Elle n'est plus appelée depuis que le calcul des
       positions est assuré par un module unique — qui prend lui-même en
       charge ce cas (voir « neutralisationFigeLOrdre » dans
       81-moteur-course). On conserve la fonction, vidée, car son résultat
       est encore lu par le diagnostic d'installation du module. */
